...
import { createActivityTypeAction } from '@/app/entities/categories/[server]/create/createActivityType.actions';
...
import type { CreateCategoryState } from "@/app/entities/categories/[server]/create/createCategory.stateType";
