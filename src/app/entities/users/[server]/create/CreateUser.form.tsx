...
import { createUserAction } from '@/app/entities/users/[server]/create/createUser.action';
import  type { CreateUserStateType } from "@/app/entities/users/[server]/create/createUser.stateType";
...
import { createUserSchema } from "@/app/entities/users/[server]/create/createUser.schema";
...
export function CreateUserForm(): JSX.Element {
  ...
  const [state, formAction, isPending]  = useActionState<CreateUserStateType, FormData>(createUserAction, {success: false } as CreateUserStateType);
