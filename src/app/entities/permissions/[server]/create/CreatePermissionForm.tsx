...
import { createPermissionAction } from '@/app/entities/permissions/[server]/create/createPermission.action';
import  type { CreatePermissionState } from "@/app/entities/permissions/[server]/create/createPermission.stateType";
import { Button } from '@/components/ui/Button';
import { Input } from '@/components/ui/Input';
// import { toast } from 'sonner';
import { zodResolver } from '@hookform/resolvers/zod';
import { createPermissionSchema } from "@/app/entities/permissions/[server]/create/createPermission.schema";
...
export function CreatePermissionForm( { setCreating, setOpenList, setDisplayingMyInfo }: CreatePermissionFormProps): JSX.Element {
  ...
  const [state, formAction, isPending] = useActionState<CreatePermissionState, FormData>(createPermissionAction, {success: false } as CreatePermissionState);
