...
import { createCourseAction } from '@/app/entities/courses/[server]/create/createCourse.action';
import type { CreateCourseStateType } from '@/app/entities/courses/[server]/create/createCourseForm.stateType';
...
export default function CreateCourseForm(): JSX.Element {
  ...
  const [state, formAction, isPending] = useActionState<CreateCourseStateType, FormData>(createCourseAction, { success: false } as CreateCourseStateType);
