...
import { updateRoleFormAction, type UpdateRoleFormState } from '@/server/actions/updateRoleForm.action';
...
export function UpdateRoleForm({role}: UpdateRoleFormProps ): JSX.Element {
  ...
  const [state, formAction, isPending] = useActionState<UpdateRoleFormState, FormData>(updateRoleFormAction, {} as UpdateRoleFormState);
