...
import type { ListBinOutput } from "@/shared/trash/trash.dto";
import type { ReadTrashFolderOutput } from "@/shared/trash/trash-node.types";
import type {
  TrashToBinOutput,
...
import { listBin } from "@/server/services/trash/listBin.service";
import { readTrashFolder } from "@/server/services/trash/readTrashFolder.service";
import { trashToBin } from "@/server/services/trash/trashToBin.service";
import { restoreFromBin } from "@/server/services/trash/restoreFromBin.service";
import { deleteForever } from "@/server/services/trash/deleteForever.service";
