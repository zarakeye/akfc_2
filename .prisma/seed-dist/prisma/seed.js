...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var PERMISSIONS, permissionRecords, _i, PERMISSIONS_1, permission, perm, adminRole, password, hash, adminUser;
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, prisma.role.upsert({
                            ...
                            create: {
                                name: 'ADMIN',
                                permissions: {
                                    create: permissionRecords.map(function (permission) { return ({
                ...
                case 7:
                    ...
                    return [4 /*yield*/, prisma.user.upsert({
                            where: { email: 'stephane.bazze@outlook.fr' },
                            update: {},
                            create: {
                                email: 'stephane.bazze@outlook.fr',
                                password: hash,
                                roleId: adminRole.id,
                            },
                        })];
