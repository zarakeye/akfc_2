...
"[project]/packages/backend/src/domain/auth/getSessionFromRequest.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/backend/src/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$auth$2f$getSessionFromRequest$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/auth/getSessionFromRequest.ts [app-route] (ecmascript)");
;
;
;
;
...
async function createTRPCContext({ req }) {
    const sessionClient = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$auth$2f$getSessionFromRequest$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionFromRequest"])(req);
    return {
        sessionClient,
...
"[project]/packages/backend/src/domain/cloudinary/cloudinary.client.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$cloudinary$2e$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/cloudinary.client.ts [app-route] (ecmascript) <locals>");
...
"[project]/packages/backend/src/domain/cloudinary/utils/cloudinary.utils.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/backend/src/domain/cloudinary/services/move.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$cloudinary$2e$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/cloudinary.client.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$cloudinary$40$2$2e$8$2e$0$2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__v2__as__cloudinary$3e$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/cloudinary@2.8.0/node_modules/cloudinary/cloudinary.js [app-route] (ecmascript) <export v2 as cloudinary>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$utils$2f$cloudinary$2e$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/utils/cloudinary.utils.ts [app-route] (ecmascript)");
;
;
async function moveService(intent) {
   ...
   */ if (source.type === 'selection') {
        ...
        if (target.type === 'virtual-folder') {
            for (const asset of uniqueAssets){
                const nextPublicId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$utils$2f$cloudinary$2e$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["replaceStatusSegment"])(asset.public_id, target.status);
   ...
   * ---------------------------------------------------------------------------
   */ if (target.type === 'virtual-folder') {
        const newPrefix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$utils$2f$cloudinary$2e$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["replaceStatusSegment"])(source.fullPath, target.status);
        if (source.type === 'file') {
   ...
   */ if (target.type === 'folder') {
        if (source.type === 'file') {
            const newPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$utils$2f$cloudinary$2e$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["moveFileIntoFolder"])(source.fullPath, target.fullPath);
            const info = await getAssetInfo(source.fullPath);
 ...
 */ async function moveSelectionIntoFolder(params) {
   ...
   */ const isExcluded = (publicId)=>excluded.some((ex)=>publicId === ex || publicId.startsWith(`${ex}/`));
    for (const root of roots){
        ...
        const asset = await tryGetAsset(root);
        if (asset) {
            const newPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$utils$2f$cloudinary$2e$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["moveFileIntoFolder"])(asset.public_id, targetFolder);
...
"[project]/packages/backend/src/domain/cloudinary/tree/finder.tree.v1.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/backend/src/domain/cloudinary/tree/index.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$tree$2f$finder$2e$tree$2e$v1$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/tree/finder.tree.v1.ts [app-route] (ecmascript)");
;
}),
"[project]/packages/backend/src/domain/cloudinary/tree/finder.tree.v1.ts [app-route] (ecmascript) <export buildCloudinaryTree as buildCloudinaryTreeV1>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "buildCloudinaryTreeV1",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$tree$2f$finder$2e$tree$2e$v1$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildCloudinaryTree"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$tree$2f$finder$2e$tree$2e$v1$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/tree/finder.tree.v1.ts [app-route] (ecmascript)");
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$cloudinary$2e$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/cloudinary.client.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$cloudinary$40$2$2e$8$2e$0$2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__v2__as__cloudinary$3e$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/cloudinary@2.8.0/node_modules/cloudinary/cloudinary.js [app-route] (ecmascript) <export v2 as cloudinary>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$services$2f$move$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/services/move.service.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$tree$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/tree/index.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$tree$2f$finder$2e$tree$2e$v1$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__buildCloudinaryTree__as__buildCloudinaryTreeV1$3e$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/tree/finder.tree.v1.ts [app-route] (ecmascript) <export buildCloudinaryTree as buildCloudinaryTreeV1>");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/backend/src/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$utils$2f$cloudinary$2e$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/backend/src/domain/cloudinary/utils/cloudinary.utils.ts [app-route] (ecmascript)");
;
;
...
const cloudinaryRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$trpc$2f$core$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["router"])({
   ...
   */ getFolderTree: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$trpc$2f$core$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].use(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$routers$2f$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isAdmin"]).input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$4$2e$1$2e$12$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        ...
        const finderTree = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$tree$2f$finder$2e$tree$2e$v1$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__buildCloudinaryTree__as__buildCloudinaryTreeV1$3e$__["buildCloudinaryTreeV1"])(resources, registered.map((f)=>f.fullPath), normalizedPath);
    ...
    getPendingTree: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$trpc$2f$core$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].query(async ()=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$tree$2f$finder$2e$tree$2e$v1$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__buildCloudinaryTree__as__buildCloudinaryTreeV1$3e$__["buildCloudinaryTreeV1"])(resources, [
            rootPath
        ], rootPath);
    }),
   ...
   */ move: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$trpc$2f$core$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$contracts$2f$schemas$2f$cloudinary$2f$move$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["moveSchema"]).mutation(async ({ input })=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$services$2f$move$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["moveService"])(input);
        ...
        if (target.type === "virtual-folder") {
            ...
            if (source.type === "folder") {
                ...
                assertSafePath(fromPrefix);
                assertNotInTrashStorage(fromPrefix);
                const toPrefix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$domain$2f$cloudinary$2f$utils$2f$cloudinary$2e$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["replaceStatusSegment"])(fromPrefix, target.status);
                assertSafePath(toPrefix);
                assertNotInTrashStorage(toPrefix);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e403c12b._.js.map