...
async function renderDoc(slug) {
    ...
    const source = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["default"].readFileSync(filePath, "utf8");
    const { data } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$gray$2d$matter$40$4$2e$0$2e$3$2f$node_modules$2f$gray$2d$matter$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])(source);
    const modulePath = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].relative(process.cwd(), filePath).replace(/\.mdx$/, "");
    const Content = (await __turbopack_context__.f({
        "@/lib/docs/docs.mdx": {
            id: ()=>"[project]/apps/web/src/lib/docs/docs.mdx.tsx [app-rsc] (ecmascript, async loader)",
            module: ()=>__turbopack_context__.A("[project]/apps/web/src/lib/docs/docs.mdx.tsx [app-rsc] (ecmascript, async loader)")
        }
    }).import(`@/${modulePath}.mdx`)).default;
    return {
        Content,
        frontmatter: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec1aa12f._.js.map