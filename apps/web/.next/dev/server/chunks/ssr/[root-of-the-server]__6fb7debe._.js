...
async function CodeSnippet({ codeJson, language = "ts", title = "Educational snippet", filename, highlightLines, scopeLines, showLineNumbers = true, startingLineNumber = 1, kind = "educational" }) {
    const code = parseCodeJson(codeJson);
...
function parseCodeJson(codeJson) {
    ...
    try {
        ...
        return codeJson.trim().replace(/^['"]|['"]$/g, "").replace(/\\n/g, "\n").replace(/\\"/g, '"').replace(/\\\\/g, "\\");
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6fb7debe._.js.map