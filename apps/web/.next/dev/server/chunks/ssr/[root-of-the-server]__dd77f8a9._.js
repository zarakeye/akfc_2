...
"[project]/apps/web/src/server/cloudinary/services/upload.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$cloudinary$2f$services$2f$upload$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/server/cloudinary/services/upload.ts [app-rsc] (ecmascript)");
...
async function picturesDragNDropFormAction(_, formData) {
    try {
        ...
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].category.findUnique({
            where: {
        ...
        let activitySlug;
        if (activityId) {
            const course = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].course.findUnique({
                where: {
        ...
        for (const file of files){
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$cloudinary$2f$services$2f$upload$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["uploadToCloudinaryAuthenticated"])(file, {
                folder,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dd77f8a9._.js.map