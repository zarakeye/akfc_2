module.exports = [
"[project]/packages/backend/src/cloudinary/move.guards.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/backend/src/cloudinary/move.guards.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function VirtualFolderNodeComponent({ node, currentPath, onOpen, onMove, binHasItems }) {
    ...
    const handleDragOver = (e)=>{
        ...
        try {
            ...
            const ok = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canMove"])(source, {
                type: 'virtual-folder',
                status: node.status
            });
            setIsOver(true);
    ...
    const handleDrop = (e)=>{
        ...
        try {
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canMove"])(source, intent.target)) return;
            onMove(intent);
        } catch (err) {
...
function handleDocumentDragOver(e) {
    ...
    const ok = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canMove"])(sourceRef, target);
...
function FolderNodeComponent({ folder, currentPath, onOpen, onMove, isOpen, onToggleOpen, multiSelectActive, openFolders, setOpenFolders, trashMap, binHasItems }) {
    ...
    const handleDragOver = (e)=>{
        ...
        try {
            ...
            const ok = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canMove"])(source, target);
            setIsOver(true);
            setIsForbidden(!ok);
            e.dataTransfer.dropEffect = ok ? 'move' : 'none';
        } catch  {
    ...
    const handleDrop = (e)=>{
        ...
        try {
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canMove"])(source, target)) return;
            onMove({
                source,
                target
            });
...
function FinderLayout() {
   ...
   */ function handleMove(intent) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$backend$2f$src$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canMove"])(intent.source, intent.target)) {
...
//# sourceMappingURL=_b439f77f._.js.map