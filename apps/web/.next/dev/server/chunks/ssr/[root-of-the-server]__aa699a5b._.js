...
(()=>{
    const e = new Error("Cannot find module '@/components/docs/DocsShell'");
...
(()=>{
    const e = new Error("Cannot find module '@/lib/docs/docs.mdx'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aa699a5b._.js.map