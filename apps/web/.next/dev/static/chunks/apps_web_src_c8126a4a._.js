...
const useCategoryStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$8_$40$types$2b$react$40$19$2e$2$2e$2_react$40$19$2e$2$2e$0_use$2d$sync$2d$external$2d$store$40$1$2e$6$2e$0_react$40$19$2e$2$2e$0_$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
   ...
   */ fetchCategoryById: async (id)=>{
            ...
            if (categoryCached) {
                ...
                const category = await trpcClient.category.getById.query({
                    id
                });
                return category;
            }
   ...
   */ fetchCategoryByType: async (type)=>{
            ...
            if (categoryCached) {
                ...
                const category = await trpcClient.category.getByType.query({
                    type
                });
                return category;
            }
   ...
   */ createCategory: async (type)=>{
            const newCategory = await trpcClient.category.create.mutate({
                type
            });
            set((state)=>({
                    categories: [
   ...
   */ deleteCategory: async (id)=>{
            await trpcClient.category.delete.mutate({
                id
            });
            set((state)=>({
   ...
   */ updateCategory: async (id, type)=>{
            const updated = await trpcClient.category.update.mutate({
                id,
                type
            });
            set((state)=>({
...
//# sourceMappingURL=apps_web_src_c8126a4a._.js.map