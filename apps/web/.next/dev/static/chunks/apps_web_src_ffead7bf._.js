...
"[project]/apps/web/src/server/cloudinary/move.guards.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/server/cloudinary/move.guards.ts [app-client] (ecmascript)");
;
...
function VirtualFolderNodeComponent({ node, currentPath, onOpen, onMove, binHasItems }) {
    ...
    const handleDragOver = (e)=>{
        ...
        try {
            ...
            const ok = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canMove"])(source, {
                type: 'virtual-folder',
                status: node.status
            });
            setIsOver(true);
    ...
    const handleDrop = (e)=>{
        ...
        try {
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canMove"])(source, intent.target)) return;
            onMove(intent);
        } catch (err) {
...
function handleDocumentDragOver(e) {
    ...
    const ok = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canMove"])(sourceRef, target);
...
function FolderNodeComponent({ folder, currentPath, onOpen, onMove, isOpen, onToggleOpen, multiSelectActive, openFolders, setOpenFolders, trashMap, binHasItems }) {
    ...
    const handleDragOver = (e)=>{
        ...
        try {
            ...
            const ok = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canMove"])(source, target);
            setIsOver(true);
            setIsForbidden(!ok);
            e.dataTransfer.dropEffect = ok ? 'move' : 'none';
        } catch  {
    ...
    const handleDrop = (e)=>{
        ...
        try {
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canMove"])(source, target)) return;
            onMove({
                source,
                target
            });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$features$2f$cloudinary$2d$finder$2f$state$2f$selection$2f$useSelectionStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/features/cloudinary-finder/state/selection/useSelectionStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/trpcClient.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$features$2f$cloudinary$2d$finder$2f$utils$2f$binTrashUI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/features/cloudinary-finder/utils/binTrashUI.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
...
function TreeView({ roots, currentPath, onOpen, onMove, appRoot }) {
   ...
   */ const listBin = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].trash.listBin.useQuery({
        appRoot,
        limit: 100,
        cursor: null
    }, {
...
function FolderContentView({ folder, onOpenFolder, onSelectFile, onMove, onOpenTrashEntry }) {
    ...
    const utils = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].useUtils();
    ...
    const listBin = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].trash.listBin.useQuery(listBinQueryInput, {
        enabled: inBin,
        refetchOnWindowFocus: false,
        staleTime: 5_000
    });
    ...
    const deleteForever = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].trash.deleteForever.useMutation({
        /**
...
_s(FolderContentView, "dc/+UHBZ/A4Zs+P0prFbX0oJoVE=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$features$2f$cloudinary$2d$finder$2f$state$2f$selection$2f$useSelectionStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelectionStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$features$2f$cloudinary$2d$finder$2f$state$2f$selection$2f$useSelectionStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelectionStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].useUtils
    ];
});
...
function FilePreviewSidebarInner({ file, onClose, readOnly }) {
    ...
    const trashToBin = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].trash.trashToBin.useMutation({
        onSuccess: {
    ...
    const deleteForever = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].cloudinary.deletePicture.useMutation({
        onSuccess: {
    ...
    const renamePicture = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].cloudinary.renamePicture.useMutation({
        onSuccess: {
...
function BinRootView({ appRoot, onOpenTrashFolder, onSelectTrashFile }) {
    ...
    const { data, isLoading, isError, error } = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].trash.listBin.useQuery({
        appRoot,
        limit: 100,
        cursor: null
    });
...
function TrashFolderView({ appRoot, trashId, relativePath, onOpenRelativeFolder, onSelectTrashFile }) {
    _s();
    const { data, isLoading, isError, error } = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].trash.readTrashFolder.useQuery({
        appRoot,
        trashId,
...
function BreadCrumbInner({ path, parsed, onNavigate }) {
    ...
    const renameFolderPrefix = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].cloudinary.renameFolderPrefix.useMutation({
        onSuccess: {
...
function MultiSelectSidebar({ currentPath, currentFolderHasContent }) {
    ...
    const restoreFromBin = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].trash.restoreFromBin.useMutation({
        onSuccess: {
    ...
    const move = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].cloudinary.move.useMutation({
        onSuccess: {
...
function FinderLayout() {
    ...
    const { data: tree, isLoading, isError } = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].cloudinary.getFolderTree.useQuery({
        path: APP_SHORT_NAME
    });
    const utils = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].useUtils();
    const move = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$trpcClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trpc"].cloudinary.move.useMutation({
   ...
   */ function handleMove(intent) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$server$2f$cloudinary$2f$move$2e$guards$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canMove"])(intent.source, intent.target)) {
...
//# sourceMappingURL=apps_web_src_ffead7bf._.js.map