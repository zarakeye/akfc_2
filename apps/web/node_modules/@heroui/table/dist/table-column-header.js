...
var TableColumnHeader = (0, import_system.forwardRef)((props, ref) => {
  ...
  const thStyles = (0, import_theme.cn)(classNames == null ? void 0 : classNames.th, className, (_a = node.props) == null ? void 0 : _a.className);
  ...
  const sortIconProps = {
    ...
    "data-visible": (0, import_shared_utils.dataAttr)(((_c = state.sortDescriptor) == null ? void 0 : _c.column) === node.key),
    className: (_d = slots.sortIcon) == null ? void 0 : _d.call(slots, { class: classNames == null ? void 0 : classNames.sortIcon })
  };
  const customSortIcon = typeof sortIcon === "function" ? sortIcon(sortIconProps) : (0, import_react.isValidElement)(sortIcon) && (0, import_react.cloneElement)(sortIcon, sortIconProps);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    Component,
    {
      ...
      children: [
        ...
        allowsSorting && (customSortIcon || /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_shared_icons.ChevronDownIcon, { strokeWidth: 3, ...sortIconProps }))
      ]
    }
  );
});
