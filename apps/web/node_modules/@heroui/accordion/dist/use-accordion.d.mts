...
import { SelectionBehavior, MultipleSelection } from '@react-types/shared';
...
declare function useAccordion<T extends object>(props: UseAccordionProps<T>): {
    ...
    itemClasses: _heroui_theme.SlotsToClasses<"base" | "content" | "trigger" | "startContent" | "heading" | "indicator" | "titleWrapper" | "title" | "subtitle"> | undefined;
};
