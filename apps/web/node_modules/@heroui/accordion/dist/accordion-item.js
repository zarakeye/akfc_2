...
function useAccordionItem(props) {
  ...
  const getButtonProps = (props2 = {}) => {
    ...
    return {
      ...
      ...(0, import_shared_utils.mergeProps)(buttonProps, hoverProps, pressProps, props2, {
        onClick: (0, import_shared_utils.chain)(pressProps.onClick, onClick)
      })
    };
  };
  const getContentProps = (0, import_react.useCallback)(
    (props2 = {}) => {
      return {
        ...
        ...(0, import_shared_utils.mergeProps)(regionProps, props2)
      };
    },
