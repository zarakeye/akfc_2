...
function useToast(originalProps) {
  ...
  const hasCalledOnCloseRef = (0, import_react.useRef)(false);
  (0, import_react.useEffect)(() => {
  ...
  const baseStyles = (0, import_theme.cn)(className, classNames == null ? void 0 : classNames.base);
  ...
  const getToastProps = (0, import_react.useCallback)(
    (props2 = {}) => {
      ...
      return {
        ref: domRef,
        className: slots.base({ class: (0, import_theme.cn)(baseStyles, classNames == null ? void 0 : classNames.base) }),
        ...
        ...(0, import_shared_utils.mergeProps)(props2, otherProps, toastProps, hoverProps)
      };
    },
    [
      slots,
  ...
  const getLoadingComponentProps = (0, import_react.useCallback)(
    (props2 = {}) => ({
  ...
  const getSpinnerComponentProps = (0, import_react.useCallback)(
    (props2 = {}) => ({
  ...
  const getContentProps = (0, import_react.useCallback)(
    (props2 = {}) => ({
      ...
      ...(0, import_shared_utils.mergeProps)(props2, otherProps, contentProps)
    }),
    [contentProps]
  );
  const getTitleProps = (0, import_react.useCallback)(
    (props2 = {}) => ({
      ...
      ...(0, import_shared_utils.mergeProps)(props2, otherProps, titleProps)
    }),
    [titleProps]
  );
  const getDescriptionProps = (0, import_react.useCallback)(
    (props2 = {}) => ({
      ...
      ...(0, import_shared_utils.mergeProps)(props2, otherProps, descriptionProps)
    }),
    [descriptionProps]
  );
