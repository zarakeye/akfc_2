...
import {useGlobalListeners as $lSlq7$useGlobalListeners, focusWithoutScrolling as $lSlq7$focusWithoutScrolling, clamp as $lSlq7$clamp, mergeProps as $lSlq7$mergeProps, useFormReset as $lSlq7$useFormReset, getEventTarget as $lSlq7$getEventTarget} from "@react-aria/utils";
...
function $47b897dc8cdb026b$export$8d15029008292ae(opts, state) {
    ...
    return {
        inputProps: (0, $lSlq7$mergeProps)(focusableProps, fieldProps, {
            ...
            onChange: (e)=>{
                state.setThumbValue(index, parseFloat((0, $lSlq7$getEventTarget)(e).value));
            }
        }),
        thumbProps: {
            ...interactions,
