...
function $5eb806b626475377$export$8d15029008292ae(opts, state) {
    ...
    (0, $cqSUd$reactariautils.useFormReset)(inputRef, state.defaultValues[index], (v)=>{
    ...
    return {
        inputProps: (0, $cqSUd$reactariautils.mergeProps)(focusableProps, fieldProps, {
            ...
            onChange: (e)=>{
                state.setThumbValue(index, parseFloat((0, $cqSUd$reactariautils.getEventTarget)(e).value));
            }
        }),
        thumbProps: {
            ...interactions,
