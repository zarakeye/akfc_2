...
import {useLayoutEffect as $ckyCP$useLayoutEffect, focusWithoutScrolling as $ckyCP$focusWithoutScrolling, mergeProps as $ckyCP$mergeProps, getEventTarget as $ckyCP$getEventTarget} from "@react-aria/utils";
...
function $6cc546b19ee7130a$export$b8cbbb20a51697de(props, state, ref) {
    ...
    return {
        regionProps: (0, $ckyCP$mergeProps)(landmarkProps, hoverProps, focusWithinProps, {
            ...
            onFocus: (e)=>{
                let target = (0, $ckyCP$getEventTarget)(e).closest('[role="alertdialog"]');
