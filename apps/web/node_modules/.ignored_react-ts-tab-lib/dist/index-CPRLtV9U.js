...
class bt extends fn {
  ...
  initPlayback(e, n) {
    ...
    const c = Oi(a.owner.current, l, e, { ...this.options, duration: s, times: i, ease: r });
...
const _i = {
  ...
  duration: 0.3
}, ji = (t, { keyframes: e }) => e.length > 2 ? Ui : le.has(t) ? t.startsWith("scale") ? Gi(e[1]) : _i : $i;
...
function Tn(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  ...
  for (const h in l) {
    ...
    if (window.MotionHandoffAnimation) {
      const p = Ts(t);
      if (p) {
        const T = window.MotionHandoffAnimation(p, h, D);
        T !== null && (b.startTime = T, v = !0);
      }
    }
    bs(t, h), d.start(zi(h, d, f, t.shouldReduceMotion && $t.has(h) ? { type: !1 } : b, t, v));
    const y = d.animation;
    y && u.push(y);
  }
...
function An(t) {
  ...
  const e = {};
  for (let n = 0; n < Zi; n++) {
    const s = Et[n], i = t.props[s];
    (Dt(i) || i === !1) && (e[s] = i);
  }
  return e;
}
const Ji = [...Rt].reverse(), Qi = Rt.length;
function er(t) {
...
function tr(t) {
  ...
  function o(l) {
    ...
    let f = {}, b = 1 / 0;
    for (let y = 0; y < Qi; y++) {
      const p = Ji[y], T = n[p], V = u[p] !== void 0 ? u[p] : c[p], C = Dt(V), g = p === l ? T.isActive : null;
      g === !1 && (b = y);
      let A = V === c[p] && V !== u[p] && C;
      if (A && s && t.manuallyAnimateOnMount && (A = !1), T.protectedKeys = { ...f }, // If it isn't active and hasn't *just* been set as inactive
      ...
      for (const M in Pn) {
        ...
        if (f.hasOwnProperty(M))
          continue;
        let fe = !1;
        Ze(E) && Ze(de) ? fe = !Vn(E, de) : fe = E !== de, fe ? E != null ? Xe(M) : d.add(M) : E !== void 0 && d.has(M) ? Xe(M) : T.protectedKeys[M] = !0;
      }
      T.prevProp = V, T.prevResolvedValues = _, T.isActive && (f = { ...f, ..._ }), s && t.blockInitialAnimation && (m = !1), m && (!(A && w) || P) && h.push(...F.map((M) => ({
        animation: M,
        options: { type: p }
      })));
    }
...
class sr extends q {
  ...
  updateAnimationControlsSubscription() {
    ...
    It(e) && (this.unmountControls = e.subscribe(this.node));
  }
  /**
...
class dr extends q {
  mount() {
    const { current: e } = this.node;
    e && (this.unmount = fs(e, (n, s) => (wt(this.node, s, "Start"), (i, { success: r }) => wt(this.node, i, r ? "End" : "Cancel")), { useGlobalTarget: this.node.props.globalTapTarget }));
  }
  unmount() {
  }
}
...
function mr({ root: t, ...e }) {
  ...
  return s[i] || (s[i] = new IntersectionObserver(pr, { root: t, ...e })), s[i];
}
function gr(t, e, n) {
  const s = mr(e);
...
class vr extends q {
  ...
  update() {
    ...
    ["amount", "margin", "root"].some(br(e, n)) && this.startObserver();
  }
  unmount() {
  }
}
...
const Ar = [...hn, x, j], Sr = (t) => Ar.find(cn(t)), wr = /* @__PURE__ */ new WeakMap();
function xr(t, e, n) {
  for (const s in e) {
    const i = e[s], r = n[s];
    if (R(i))
      t.addValue(s, i), process.env.NODE_ENV === "development" && Ke(i.version === "12.6.2", `Attempting to mix Motion versions ${i.version} with 12.6.2 may not work as expected.`);
    else if (R(r))
...
class Mr {
  ...
  constructor({ parent: e, props: n, presenceContext: s, reducedMotionConfig: i, blockInitialAnimation: r, visualState: o }, a = {}) {
    ...
    this.onUpdate = c, this.latestValues = l, this.baseTarget = { ...l }, this.initialValues = n.initial ? { ...l } : {}, this.renderState = u, this.parent = e, this.props = n, this.presenceContext = s, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = i, this.options = a, this.blockInitialAnimation = !!r, this.isControllingVariants = Kn(n), this.isVariantNode = Nn(n), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
    const { willChange: h, ...d } = this.scrapeMotionValuesFromProps(n, {}, this);
    for (const f in d) {
      const b = d[f];
      l[f] !== void 0 && R(b) && b.set(l[f], !1);
    }
  }
  mount(e) {
    this.current = e, wr.set(e, this), this.projection && !this.projection.instance && this.projection.mount(e), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((n, s) => this.bindToMotionValue(s, n)), xn.current || Vr(), this.shouldReduceMotion = this.reducedMotionConfig === "never" ? !1 : this.reducedMotionConfig === "always" ? !0 : Oe.current, process.env.NODE_ENV !== "production" && Ke(this.shouldReduceMotion !== !0, "You have Reduced Motion enabled on your device. Animations may not appear as expected."), this.parent && this.parent.children.add(this), this.update(this.props, this.presenceContext);
  }
  unmount() {
    this.projection && this.projection.unmount(), Te(this.notifyUpdate), Te(this.render), this.valueSubscriptions.forEach((e) => e()), this.valueSubscriptions.clear(), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this);
    for (const e in this.events)
      this.events[e].clear();
  ...
  readValue(e, n) {
    ...
    return i != null && (typeof i == "string" && (ln(i) || Zt(i)) ? i = parseFloat(i) : !Sr(i) && j.test(n) && (i = rn(e, n)), this.setBaseTarget(e, R(i) ? i.get() : i)), R(i) ? i.get() : i;
  }
  /**
  ...
  getBaseTarget(e) {
    ...
    if (typeof s == "string" || typeof s == "object") {
      const o = Mt(this.props, s, (n = this.presenceContext) === null || n === void 0 ? void 0 : n.custom);
      o && (i = o[e]);
    }
    if (s && i !== void 0)
      return i;
...
class Cr extends Mn {
  ...
  readValueFromInstance(e, n) {
    if (le.has(n))
      return qs(e, n);
    {
      const s = Pr(e), i = (kn(n) ? s.getPropertyValue(n) : s[n]) || 0;
...
class Fr extends Mn {
  constructor() {
    super(...arguments), this.type = "svg", this.isSVGTag = !1, this.measureInstanceViewportBox = wn, this.updateDimensions = () => {
      this.current && !this.renderState.dimensions && Gn(this.current, this.renderState);
    };
  }
  getBaseTargetFromProps(e, n) {
    return e[n];
  ...
  readValueFromInstance(e, n) {
    ...
    return n = $n.has(n) ? n : Un(n), e.getAttribute(n);
  }
  scrapeMotionValuesFromProps(e, n, s) {
    return jn(e, n, s);
  }
  ...
  build(e, n, s) {
    qn(e, n, this.isSVGTag, s.transformTemplate);
  }
...
const Dr = (t, e) => Wn(t) ? new Fr(e) : new Cr(e, {
  allowProjection: t !== Yn
}), Er = {
  renderer: Dr,
  ...or,
  ...Tr
