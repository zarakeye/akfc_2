...
import { createRoleFormAction, type CreateRoleFormState } from '@/server-actions/createRoleForm.action';
 ...
 *
 * Displays a form with fields for name, description, and permissions.
...
export function CreateRoleForm(): JSX.Element {
  ...
  const [state, formAction, isPending] = useActionState<CreateRoleFormState, FormData>(createRoleFormAction, {} as CreateRoleFormState);
