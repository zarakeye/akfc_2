...
import TextEditor from '@/features/editor-tiptap/components/TextEditor';
import { createCourseFormAction, type CreateCourseStateType } from '@/features/admin/courses/actions/createCourseForm.action';
 ...
 *
 * The form fields are label, content, beginAt, endAt, day and coachId.
 *
 * The content field is a JSON object that should contain the course content.
 *
 * The beginAt and endAt fields are the start and end times of the course, respectively.
 * They are represented as a number of minutes since midnight.
 *
 * The day field is the day of the week on which the course will be given.
 * It should be one of the following values: MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY.
 *
 * The coachId field is the ID of the coach who will be giving the course.
 */
export default function CreateCourseForm(): JSX.Element {
  ...
  const [state, formAction, isPending] = useActionState<CreateCourseStateType, FormData>(createCourseFormAction, { success: false } as CreateCourseStateType);
