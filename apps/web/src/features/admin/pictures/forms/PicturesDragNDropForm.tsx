...
import { picturesDragNDropFormAction, type PicturesDragNDropFormState } from '@/features/admin/pictures/actions/picturesDragNDropForm.action';
import { useSessionStore } from '@/lib/stores/useSessionStore';
import { useCategoryStore } from '@/lib/stores/useCategoryStore';
import { useCourseStore } from '@/lib/stores/useCourseStore';
import type { PicturesDragNDropFormValuesType } from '@/features/admin/pictures/types/picturesDragNDropForm.types';
...
import { CropResult } from '@/features/gallery-crop/types/cropper.types';

const initialState = { success: false };

/**
 * PicturesDragNDropForm - Formulaire pour uploader des images en drag-n-drop.
 * 
 * @returns {JSX.Element} - Le composant JSX de la formulaire.
 */
