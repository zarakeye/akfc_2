    ...
    <div className="fixed right-4 top-1/2 z-40 hidden -translate-y-1/2 xl:flex">
      <div className="flex flex-col items-center gap-3 rounded-full border bg-background/85 px-2 py-3 shadow-sm backdrop-blur">
        ...
        <div className="relative h-40 w-8">
          <div className="absolute left-1/2 top-0 h-full w-1 -translate-x-1/2 overflow-hidden rounded-full bg-muted">
            <div
          ...
          <div
            className="absolute left-1/2 -translate-x-1/2 rounded-full border bg-background px-2 py-0.5 text-[10px] font-medium text-foreground shadow-sm transition-[bottom] duration-150"
            style={bubbleStyle}
          >
            {Math.round(progress)}%
          </div>
